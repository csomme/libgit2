...
#ifndef GIT_WIN32
	must_be_true((loose_object_dir_mode(TEMP_REPO_FOLDER, (git_object *)tree) & 0777) == 0777);
	must_be_true((loose_object_mode(TEMP_REPO_FOLDER, (git_object *)tree) & 0777) == 0444);
#endif
	git_tree_close(tree);
